...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView limitCountTextView = findViewById(R.id.limitCountTextView);
        EditText titleEditText = findViewById(R.id.titleEditText);
        EditText rewardEditText = findViewById(R.id.rewardEditText);
        EditText limitCountEditText = findViewById(R.id.limitCountEditText);
        LinearLayout limitCountLayout = findViewById(R.id.limitCountLayout);
        ...
        buttonAdd.setOnClickListener(v -> {
            ...
            builder.setPositiveButton("确认", (dialog, which) -> {
                ...
                switch(finalTaskType){
                    case 0:
                    case 1:
                        task = new Task(title, reward, finalTaskType, finalLimitCount, selectedDays);
                        break;
                    case 2:
                        task = new Task(title, reward, finalTaskType, selectedDays.size(), selectedDays);
                        break;
                }
